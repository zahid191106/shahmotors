...
// 1. Define the TypeScript interface for the prop
interface BlogsProps {
    limit?: number;
}

// 2. Extracted the blog dataset out of the component return to keep things scannable
const allBlogs = [
    {
...
export default function Blogs({ limit }: BlogsProps) {
    // Slice the array if a limit prop is provided, otherwise take the whole array
