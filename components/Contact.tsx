                ...
                <div className="max-w-7xl mx-auto text-center space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 pt-16">
                        ...
                        <div className='grid gap-2'>
                            {/* Phone Card */}
                            <a href="tel:+353833526830" className="grid md:grid-cols-2 items-center bg-white rounded-3xl overflow-hidden shadow-[0_15px_40px_-10px_rgba(0,0,0,0.1)] border border-gray-100 group transition-all hover:-translate-y-2 p-5 space-y-6">
                            ...
                            {/* WhatsApp Card */}
                            <a href="https://wa.me/+353833526830" className="grid md:grid-cols-2 items-center bg-white rounded-3xl overflow-hidden shadow-[0_15px_40px_-10px_rgba(0,0,0,0.1)] border border-gray-100 group transition-all hover:-translate-y-2 p-5 space-y-6">
                            ...
                            {/* Email Card */}
                            <a href="mailto:shahmotors14@yahoo.com" className="grid md:grid-cols-2 items-center bg-white rounded-3xl overflow-hidden shadow-[0_15px_40px_-10px_rgba(0,0,0,0.1)] border border-gray-100 group transition-all hover:-translate-y-2 p-5 space-y-6">
